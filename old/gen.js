  ...
  function () {
    ...
    var assq$202 =
      _f(function (x$203, param$366) {
           ...
           console.log(`assq: key ${x$203} not found`);
           throw $(Not_found$20g);
         });
    var mem_assoc$207 =
  ...
  function () {
    ...
    var random_picture$90 =
      _f(function (str$91) {
           ...
           if (dna_size === undefined)
              dna_size = _(oc$Util$[5], [ 120, 200 ]);
           else _(oc$Util$[5], [ 120, 200 ]);
           var ops$102 = _(oc$Op$[11], [ oc$Op$[3] ]);
           var seed$103 = $(_(oc$Gene$[5], [ x$94, y$95 ]), $(_(oc$Gene$[4], [ t$96 ]), 0));
           var g$104 =
             _(oc$Gene$[14], [ _(oc$Pervasives$[21], [ _(oc$Gene$[12], [ ops$102, seed$103, $(3, 0), dna_size ]), seed$103 ]) ]);
...
const compute_pixel = ocaml_get("compute_pixel");
function new_picture(size, seed) {
  dna_size = size;
  return ocaml_get("new_picture")(seed);
}
